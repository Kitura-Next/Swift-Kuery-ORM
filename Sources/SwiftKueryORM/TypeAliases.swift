...
/// Type Alias for RequestError from [KituraContracts](https://github.com/Kitura-Next/KituraContracts)
public typealias RequestError = KituraContracts.RequestError

/// Type Alias for SQLDataType from [SwiftKuery](https://github.com/Kitura-Next/Swift-Kuery)
